...
export const COLLECTIONS: Collection[] = [
  {
    ...
    heroImage: `${PX}/767972/pexels-photo-767972.jpeg?auto=compress&cs=tinysrgb&w=1600`,
    bannerImage: `${PX}/2065200/pexels-photo-2065200.jpeg?auto=compress&cs=tinysrgb&w=1600`,
    highlights: ['Breathable linens', 'Organic cottons', 'Sun-washed palette', 'Resort-ready silhouettes'],
    pieces: 48,
    startingPrice: 1999,
  ...
  },
  {
    ...
    highlights: ['Double-faced wool', 'Cashmere blends', 'Leather outerwear', 'Layered silhouettes'],
    pieces: 52,
    startingPrice: 3499,
  ...
  },
  {
    ...
    highlights: ['Handloom textiles', 'Pure zari work', 'Jewel-tone palette', 'Artisan-crafted'],
    pieces: 36,
    startingPrice: 3999,
  ...
  },
  {
    ...
    bannerImage: `${PX}/2065200/pexels-photo-2065200.jpeg?auto=compress&cs=tinysrgb&w=1600`,
    highlights: ['Heirloom craftsmanship', 'Pure silk and zari', 'Custom tailoring available', 'Bridal styling included'],
    pieces: 28,
    startingPrice: 4999,
  ...
  },
  {
    ...
    highlights: ['Tailored fit', 'Wrinkle-resistant fabrics', 'Neutral palette', 'Desk-to-dinner versatility'],
    pieces: 44,
    startingPrice: 2999,
  ...
  },
  {
    ...
    highlights: ['Everyday essentials', 'Soft cottons', 'Relaxed fits', 'Easy-care fabrics'],
    pieces: 60,
    startingPrice: 1499,
  ...
  },
  {
    ...
    highlights: ['Full-grain leather', 'Swiss-inspired movements', 'Numbered editions', 'Lifetime warranty'],
    pieces: 22,
    startingPrice: 4999,
  ...
  },
  {
    ...
    heroImage: `${PX}/1666071/pexels-photo-1666071.jpeg?auto=compress&cs=tinysrgb&w=1600`,
    bannerImage: `${PX}/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=1600`,
    highlights: ['Heavyweight fabrics', 'Japanese selvedge', 'Garment-dyed', 'Boxy fits'],
    pieces: 34,
    startingPrice: 2499,
    products: ['p003', 'p013'],
  },
